...
- Latest verified public-pin alias checkpoint: `boat_geocode_backup_20260421152318` wrote 4 MDL Chatham Maritime Marina Boatyard marina-grade pins with `PUBLIC_MAP_ENABLED=false`; 0 rows were held back, 0 failed, 0 geography mismatches were found, the verified-alias lane selected 0 rows afterward, and the backup-scoped audit returned 4/4 eligible pins. Public pins increased to 267 and active-visible public coverage reached 2.11%.
- Latest backlog planning checkpoint: `reports/location-backlog/2026-04-21-round22.{json,md}` still keeps the public map disabled after the Chatham alias apply. It found 12,670 active visible rows, 267 public pins, 371 public-pin-likely rows, 0 country-hint mismatches, 2,965 pending-ready rows, 369 review rows, and 542 held-back coordinates. The recommended next move remains `gazetteer_first`; smaller vetted POI clusters such as Marina Anse Marcel, Marina Del Rey, Dover Marina, Green Cay, and the remaining plain Chatham Marina row need live provider proof or enrichment before any public-pin apply.

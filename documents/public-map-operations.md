...
- Verified public-pin aliases live in `documents/public-pin-aliases.md`; use them only for individually reviewed marine facilities with live provider evidence, nearby negative checks, unit tests, and the normal public-pin apply gate. Current aliases are `burnham yacht harbour`, `conwy marina`, `chichester marina`, `palm cay marina`, `medway yacht club`, `lagoon marina`, `marina frapa`, `marina baotic`, and `linton bay marina`. Do not add global `yacht harbour`, `yacht harbor`, or broad `marina` matching from this evidence.
...
- Current approved cleanup scope is narrow: recurring `Nanny Cay`/`Nanny Cay Boatyard`, `Marina Bas-Du-Fort`, `Hodge's Creek Marina Hotel`, `Camper & Nicholsons Port Louis Marina`, `Zea Marina`, `La Paz, Costa Baja Marina, Americas`, `La Cruz Marina Near Puerto Vallarta`, dirty `Shelter Bay Marina` variants, `Linton Bay Marina Garrote Coln`, `Verkoophaven Delta Marina` and `Schepenkring Delta Marina` variants, `Marina Vaiare`, `Chiapas Marina`, `Puerto Escondido Loreto Marina, BCS`, `Bluffers Park Yacht Club`, `Foxs Marina, Ipswich`, `Penarth Marina Cardiff`, `Greystones Harbour Marina`, `Northern Ireland, Carrickfergus Marina`, `Clarke's Court Boatyard & Marina`, `British Virgin Islands, Hodge's Creek Marina, Caribbean`, `Dubrovnik, Komolac, ACI Marina Dubrovnik`, `Šibenik, Marina Zaton, Mediterranean`, `Kos, Kos Marina, Mediterranean`, `Marsh Harbour, Conch Inn Marina, Bahamas`, `Port Tino Rossi`, `Port Pin Rolland`, `Marmaris Yacht Marine`, `Le Marin Martiniqe`, `Marina De L'Anse Marcel`, Dutch `Aan Verkoopsteiger In` / `Aaan Verkoopsteiger In` prefixes, Saint Martin/Sint Maarten suffix variants, misspelled place tokens (`Bahmas`, `Martiniqe`, `El Hiero`, `Santantioco`, scoped `Grenade Caribbean`), anchored Canadian Lake Huron/Osoyoos rows, directional fragments such as `North East Of`, and exact `Trogir, Yachtclub Seget (Marina Baotić)` rows may canonicalize before geocoding; one-off production text fixes are backed by `boat_location_text_cleanup_backup_20260421014841`, `boat_location_text_cleanup_backup_20260421020349`, and `boat_location_text_cleanup_backup_20260421022049`. Green Cay, St. Thomas Yacht Club, Puerto Bahia, broad Clarke's Court rows, Riva Di Traiano, Villanova, BVI Yacht Charter Docks, Marina Di Ragusa, Sune Carlsson Boatyard, Red Frog Marina, Pankor/Pangkor Marina, Ocean Marina Pattaya, Wiarton/Wiatron Marina, Marina Del Ray Orillia, Marina Riviera Nayarit, Marina Guaymas, Rio Dulce Marina, Swanwick Marina, D-Marin Lefkas, Dover Marina, Chatham Marina, Port Solent Marina, Shotley Marina, Carlyle West Access Marina, Shores Of Leech Lake Marina, Tollesbury Marina, Deko Marina, Carrickfergus Harbour Marina, Roses/Empuriabrava Marina, Northshore Shipyard Chichester, and Pembroke Dock remain review items, not public-pin normalization rules. Verified aliases such as Conwy Marina, Chichester Marina, Palm Cay Marina, Medway Yacht Club, Lagoon Marina, Marina Frapa, Marina Baotić, and Linton Bay Marina must stay in the alias lane rather than this cleanup-normalization lane. Do not add a broad `Cole Bay` or `Lagoon Marina Cole Bay` market alias until a facility-specific geocode path is proven; the round 20 `Sint Maarten`-suffixed query returned city precision.
- Latest verified public-pin alias checkpoint: `boat_geocode_backup_20260421133028` wrote 2 Linton Bay Marina marina-grade alias pins and 1 existing Lagoon Marina cache pin with `PUBLIC_MAP_ENABLED=false`; 0 rows were held back, 0 failed, 0 geography mismatches were found, and the verified-alias lane selected 0 rows afterward. A rejected Cole Bay metadata experiment was rolled back with `boat_location_market_backup_round20_202604211333` / `boat_location_market_rollback_backup_round20_202604211343`, then `boat_geocode_backup_20260421134416` repaired 2 Lagoon Marina pins from cache with 0 provider calls and a 2/2 backup-scoped audit. Public pins increased to 263 and active-visible public coverage reached 2.08%.
- Latest backlog planning checkpoint: `reports/location-backlog/2026-04-21-round21.{json,md}` still keeps the public map disabled after the Dutch Lelystad search-coverage cleanup. It found 12,666 active visible rows, 263 public pins, 371 public-pin-likely rows, 0 country-hint mismatches, 2,961 pending-ready rows, 373 review rows, and 542 held-back coordinates. The recommended next move is now `gazetteer_first`; smaller vetted POI clusters such as Marina Anse Marcel, Marina Del Rey, Chatham Marina, Dover Marina, and Green Cay need live provider proof before any public-pin apply.

...
- Latest backlog planning checkpoint: `reports/location-backlog/2026-04-21-round18.{json,md}` still recommends cleanup-first after the changed-review cleanup apply. It found 12,666 active visible rows, 248 public pins, 371 public-pin-likely rows, 0 country-hint mismatches, 2,993 pending-ready rows, 377 review rows, and 518 held-back coordinates. Its remaining top interventions are raw source cleanup, search-coverage batches, and vetted gazetteer POI work; the public map stays disabled.

...
const ADMIN_COUNTRY_HINTS: LocationCountryHint[] = [
  ...
  { country: "Mexico", region: "Nayarit", matchedTerm: "nuevo vallarta" },
  { country: "Mexico", region: "Quintana Roo", matchedTerm: "isla mujeres" },
  { country: "Mexico", region: "Baja California", matchedTerm: "ensenada" },
  // European marina/town hints that show up repeatedly in the unresolved
  // backfill buckets. Conservative: only tokens that uniquely identify a
  // country — "Victoria"/"Kingston"/"Portland" are too ambiguous, so they
  // stay out.
  { country: "Netherlands", region: "Netherlands", matchedTerm: "hindeloopen" },
  { country: "Netherlands", region: "Netherlands", matchedTerm: "monnickendam" },
  { country: "Netherlands", region: "Netherlands", matchedTerm: "colijnsplaat" },
  { country: "Netherlands", region: "Netherlands", matchedTerm: "thuishaven" },
  { country: "Sweden", region: "Sweden", matchedTerm: "västervik" },
  { country: "Sweden", region: "Sweden", matchedTerm: "vastervik" },
  { country: "Sweden", region: "Sweden", matchedTerm: "smögen" },
  { country: "Sweden", region: "Sweden", matchedTerm: "smogen" },
  { country: "Sweden", region: "Sweden", matchedTerm: "gryt" },
  { country: "Sweden", region: "Sweden", matchedTerm: "orust" },
  { country: "Sweden", region: "Sweden", matchedTerm: "göteborg" },
  { country: "Sweden", region: "Sweden", matchedTerm: "goteborg" },
  { country: "Sweden", region: "Sweden", matchedTerm: "göteborgstrakten" },
  { country: "Sweden", region: "Sweden", matchedTerm: "värmdö" },
  { country: "Sweden", region: "Sweden", matchedTerm: "varmdo" },
  { country: "Sweden", region: "Sweden", matchedTerm: "västerås" },
  { country: "Sweden", region: "Sweden", matchedTerm: "vasteras" },
  { country: "Malaysia", region: "Malaysia", matchedTerm: "langkawi" },
  { country: "Malaysia", region: "Malaysia", matchedTerm: "rebak" },
  { country: "Croatia", region: "Adriatic", matchedTerm: "zagreb" },
  { country: "Greece", region: "Aegean", matchedTerm: "megara" },
  { country: "Greece", region: "Aegean", matchedTerm: "porto heli" },
  { country: "Italy", region: "Mediterranean", matchedTerm: "san vincenzo" },
  { country: "Italy", region: "Mediterranean", matchedTerm: "san remo" },
  { country: "Italy", region: "Mediterranean", matchedTerm: "porto ercole" },
  { country: "Italy", region: "Mediterranean", matchedTerm: "scarlino" },
  { country: "France", region: "Brittany", matchedTerm: "brittany" },
  { country: "France", region: "Mediterranean", matchedTerm: "saint nazaire" },
  { country: "France", region: "Mediterranean", matchedTerm: "saint-nazaire" },
  { country: "France", region: "Mediterranean", matchedTerm: "saint mandrier" },
  { country: "France", region: "Mediterranean", matchedTerm: "saint-mandrier" },
  { country: "Chile", region: "South America", matchedTerm: "puerto montt" },
  { country: "Chile", region: "South America", matchedTerm: "puerto williams" },
  { country: "New Caledonia", region: "South Pacific", matchedTerm: "new caledonia" },
  { country: "New Caledonia", region: "South Pacific", matchedTerm: "noumea" },
  { country: "Bonaire", region: "Caribbean", matchedTerm: "bonaire" },
  { country: "Bulgaria", region: "Black Sea", matchedTerm: "varna" },
  { country: "United Kingdom", region: "United Kingdom", matchedTerm: "pendennis" },
  { country: "Guadeloupe", region: "Caribbean", matchedTerm: "saint francois" },
  { country: "Guadeloupe", region: "Caribbean", matchedTerm: "saint-francois" },
  { country: "Guadeloupe", region: "Caribbean", matchedTerm: "saint françois" },
];

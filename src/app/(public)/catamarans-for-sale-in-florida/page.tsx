...
const hub = requireSeoHub(getCategoryHub("catamarans-for-sale-in-florida"));

// 5-minute ISR matches the other category hubs.
...
export default async function CatamaransForSaleInFloridaPage() {
